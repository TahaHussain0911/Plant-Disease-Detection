...
def predict_image(img_binary):
    # Convert binary data to a file-like object
    img_pil = Image.open(BytesIO(img_binary))  # Wrap binary data in BytesIO
    # img_pil = Image.open(img_binary)  # Wrap binary data in BytesIO
